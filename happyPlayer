...
class Albumentations:
    ...
    def __init__(self, p=1.0):
        ...
        try:
            ...
            T = [
                // A.RandomResizedCrop(height=300, width=350, scale=(0.2, 1.0), ratio=(0.9, 1.11), p=0.1),
                A.CLAHE(p=0.01),
                A.RandomBrightnessContrast(p=0.5, brightness_limit=(-0.07, 0.17),
                                           contrast_limit=(-0.07, 0.17)),
                A.RandomGamma(p=0.0),
